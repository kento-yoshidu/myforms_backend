<template>
  <header class="w-full fixed top-0 bg-white px-2 py-2 z-50 border">
    <div class="md:max-w-3xl mx-auto md:flex md:items-center">
      ...
      >
        <h1>
          <a
            class="text-gray-900 text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-no-wrap"
            href="/"
          >
            MdN Cafe
          </a>
      ...
      >
        <ul class="md:flex md:justify-end md:items-end">
          <li class="w-full md:w-auto md:ml-5">
            <a
              href="/concept/"
              class="text-gray-900 md:block inline-block md:py-0 py-5 px-5 md:px-0 w-full"
              >コンセプト</a
            >
          </li>
          <li class="w-full md:w-auto md:ml-5">
