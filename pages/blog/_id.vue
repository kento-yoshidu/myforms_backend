<template>
  <all-wrapper>
    <layout-main-visual title="Blog" visual="visual-blog" />
    ...
    <main class="w-10/12 md:w-6/12 mx-auto pt-2">
      ...
      <div class="text-body mt-6 md:mt-10 md:mb-20" v-html="item.body"></div>
    </main>
  </all-wrapper>
</template>
...
.text-body h1 {
  font-size: 2.8rem;
  line-height: 1.6;
  border-bottom: 8px solid rgba(96, 165, 250, 0.9);
}
h2 {
  margin: 45px 0 8px;
  padding-left: 1rem;
  font-size: 2rem;
  border-left: 8px solid rgba(96, 165, 250, 0.9);
}
h3 {
  margin: 35px 0 0;
  font-size: 1.6rem;
...
@media screen and (max-width: 768px) {
  ...
  .text-body h1 {
    font-size: 2.1rem;
    line-height: 1.6;
    border-bottom: 7px solid rgba(96, 165, 250, 0.9);
  }
  h2 {
    margin: 30px 0 0px;
    padding-left: 1rem;
